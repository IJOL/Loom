...
/**
 * Resolve a paramId against a bare-key map. Accepts either the bare key
 * ('wt-cutoff') or a prefixed registry-style key ('main.wt-cutoff') by
 * falling back to the substring after the first '.'.
 */
