...
// `test/plugin-dsp` installs the Loom global a plugin's dsp.ts registers through,
// so it MUST stay above the plugin import below.
import '../../test/plugin-dsp';
import '../../plugins/tb303/dsp';   // register the renderer so spawn() can build a voice
