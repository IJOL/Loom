...
describe('the TB-303 plugin renderer', () => {
  it('registers itself through the Loom global, under the engine id', () => {
    expect(registered.has('tb303')).toBe(true);
  });
  ...
  it('still renders the frozen reference taken from the in-tree engine', () => {
    ...
    // src/audio-dsp/tb303-renderer.ts before this plugin existed.
    const r = new TB303Renderer(note, defaultParams(), SR);
