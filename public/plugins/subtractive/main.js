// plugins/subtractive/plugin.json
var plugin_default = {
  id: "subtractive",
  name: "Sub",
  version: "1.0.0",
  ...
  components: [
    {
      ...
      params: [
        ...
        { id: "osc1.detune", label: "Osc1 Det", kind: "continuous", min: -50, max: 50, default: 0, unit: "\xA2", group: "osc1" },
        {
          id: "osc1.wave",
          label: "Osc1 Wave",
          kind: "discrete",
        ...
        { id: "osc2.detune", label: "Osc2 Det", kind: "continuous", min: -50, max: 50, default: 7, unit: "\xA2", group: "osc2" },
        {
          id: "osc2.wave",
          label: "Osc2 Wave",
          kind: "discrete",
        ...
        },
        {
          ...
          optionsFrom: {
            ...
            table: {
              ...
              "3": [
                { value: "comb+", label: "POS" },
                { value: "comb-", label: "NEG" },
                { value: "combff", label: "FF" }
              ]
            }
          }
        },
        ...
        { id: "filter.attack", label: "F Atk", kind: "continuous", min: 1e-3, max: 2, default: 0.01, unit: "s", drawnBy: "modulators" },
        { id: "filter.decay", label: "F Dec", kind: "continuous", min: 1e-3, max: 4, default: 0.3, unit: "s", drawnBy: "modulators" },
        { id: "filter.sustain", label: "F Sus", kind: "continuous", min: 0, max: 1, default: 0.4, drawnBy: "modulators" },
        { id: "filter.release", label: "F Rel", kind: "continuous", min: 5e-3, max: 4, default: 0.35, unit: "s", drawnBy: "modulators" },
        {
          id: "amp.builtinEnv",
          label: "Built-in Env",
          kind: "discrete",
        ...
        { id: "amp.attack", label: "A Atk", kind: "continuous", min: 1e-3, max: 2, default: 0.01, unit: "s", drawnBy: "modulators" },
        { id: "amp.decay", label: "A Dec", kind: "continuous", min: 1e-3, max: 4, default: 0.2, unit: "s", drawnBy: "modulators" },
        { id: "amp.sustain", label: "A Sus", kind: "continuous", min: 0, max: 1, default: 0.7, drawnBy: "modulators" },
        { id: "amp.release", label: "A Rel", kind: "continuous", min: 5e-3, max: 4, default: 0.3, unit: "s", drawnBy: "modulators" },
        ...
        { id: "master.detune", label: "Detune", kind: "continuous", min: 0, max: 50, default: 25, unit: "\xA2", group: "master" },
