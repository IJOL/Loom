      ...
      params: [
        {
          ...
          default: 0,
          group: "osc",
          options: [{ value: "sine", label: "Sin" }, { value: "triangle", label: "Tri" }, { value: "sawtooth", label: "Saw" }]
        },
        {
          id: "osc.modWave",
          label: "Mod Wave",
          ...
          default: 0,
          group: "osc",
          options: [{ value: "sine", label: "Sin" }, { value: "triangle", label: "Tri" }]
        },
        { id: "osc.ratio", label: "Ratio", kind: "continuous", min: 0.25, max: 16, default: 2, unit: "\xD7", group: "osc" },
        ...
        { id: "osc.ring", label: "Ring/AM", kind: "continuous", min: 0, max: 1, default: 0, group: "osc" },
        {
          ...
          default: 0,
          group: "osc",
          options: [{ value: "off", label: "Off" }, { value: "2", label: "2" }, { value: "3", label: "3" }, { value: "4", label: "4" }]
        },
        ...
        { id: "timbre.symmetry", label: "Symmetry", kind: "continuous", min: -1, max: 1, default: 0, group: "timbre" },
        {
          ...
          default: 2,
          group: "lpg",
          options: [{ value: "lp", label: "LP" }, { value: "gate", label: "Gate" }, { value: "both", label: "Both" }]
        },
        ...
        { id: "lpg.resonance", label: "Resonance", kind: "continuous", min: 0, max: 1, default: 0.2, group: "lpg" },
        {
          ...
          default: 0,
          group: "contour",
          options: [{ value: "pluck", label: "Pluck" }, { value: "sustain", label: "Sus" }]
        },
        { id: "contour.attack", label: "Attack", kind: "continuous", min: 1e-3, max: 2, default: 5e-3, unit: "s", curve: "exponential", group: "contour" },
        { id: "contour.decay", label: "Decay", kind: "continuous", min: 5e-3, max: 4, default: 0.4, unit: "s", curve: "exponential", group: "contour" },
      ...
      modulators: [
        {
          ...
          kind: "adsr",
          enabled: true,
          connections: [{ id: "c-fold", paramId: "timbre.fold", depth: 0 }],
          attackSec: 0.01,
          decaySec: 0.3,
          sustain: 0.7,
          releaseSec: 0.3,
        ...
        },
        {
          ...
          kind: "adsr",
          enabled: true,
          connections: [{ id: "c-cut", paramId: "lpg.cutoff", depth: 0 }],
          attackSec: 0.01,
          decaySec: 0.3,
          sustain: 0.7,
          releaseSec: 0.3,
